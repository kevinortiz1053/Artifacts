...
def n_sarsa_c1(q, episodes, n_step, alpha):
    lamda = 0.9
    successes = 0
    success_counter = []
    episode_counter = []
    ...
    print('Number of times landed c1: ' + str(successes))
    return q, success_counter


def n_sarsa_c2(q, episodes, n_step, alpha, last_success_number):
    lamda = 0.9
    successes = last_success_number
    success_counter = []
    episode_counter = []
    ...
    for episode in range(episodes):
        ...
        success_counter.append(successes)
        episode_counter.append(episode + 1)
    print('Number of times landed c2: ' + str(successes))
    return q, success_counter


def n_sarsa_c3(q, episodes, n_step, alpha, last_success_number):
    lamda = 0.9
    successes = last_success_number
    success_counter = []
    episode_counter = []
    ...
    for episode in range(episodes):
        ...
        success_counter.append(successes)
        episode_counter.append(episode + 1)
    print('Number of times landed c3: ' + str(successes))
    return q, success_counter


def n_sarsa_c4(q, episodes, n_step, alpha, last_success_number):
    lamda = 0.9
    successes = last_success_number
    success_counter = []
    episode_counter = []
    ...
    for episode in range(episodes):
        ...
        success_counter.append(successes)
        episode_counter.append(episode + 1)
    print('Number of times landed c4: ' + str(successes))
    return q, success_counter


def n_sarsa(q, episodes, n_step, alpha, last_success_number):
    lamda = 0.9
    successes = last_success_number
    success_counter = []
    episode_counter = []
    ...
    plt.title("(seed) Curriculum 1 n-step Sarsa, n = " + str(n_step) + ', alpha = ' + str(alpha))
...
def curriculum_learning(num_episodes1, n_steps1, alpha1):
    success_array = []
    num_episodes = int(num_episodes1 / 5)

    policy, num_of_successes_array = n_sarsa_c1({}, num_episodes, n_steps1, alpha1)
    ...
    policy, num_of_successes_array = n_sarsa_c2(policy, num_episodes, n_steps1, alpha1, last_success_number)
    success_array = success_array + num_of_successes_array
    last_success_number = num_of_successes_array[len(num_of_successes_array) - 1]

    policy, num_of_successes_array = n_sarsa_c3(policy, num_episodes, n_steps1, alpha1, last_success_number)
    success_array = success_array + num_of_successes_array
    last_success_number = num_of_successes_array[len(num_of_successes_array) - 1]

    policy, num_of_successes_array = n_sarsa_c4(policy, num_episodes, n_steps1, alpha1, last_success_number)
    success_array = success_array + num_of_successes_array
    last_success_number = num_of_successes_array[len(num_of_successes_array) - 1]

    policy, num_of_successes_array = n_sarsa(policy, num_episodes, n_steps1, alpha1, last_success_number)
    success_array = success_array + num_of_successes_array
...
def averaged_run():
    ...
    success_array = []
    for k in range(10):
        num_of_successes_array = curriculum_learning(10000, n_step, alpha)
